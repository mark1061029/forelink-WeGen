...
<div class="kong-header__hMegaMenu {{::$ctrl.getID()}}"
     ng-class="[{'kong-header__hMegaMenu--arrow' : $ctrl.edited.attrs.arrow},{'kong-header__hMegaMenu--title' : $ctrl.edited.attrs.title_show},$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
...
function lhb_h_mega_menu_callback($attrs) {
    ...
    if(kong_to_boolean($attrs['arrow'])){
        $classes[] = 'kong-header__hMegaMenu--arrow';
    }

    if(kong_to_boolean($attrs['title_show'])){
        $classes[] = 'kong-header__hMegaMenu--title';
    }
    ...
    $html = '<div class="kong-header__hMegaMenu ' . implode(' ', $classes).'">';
