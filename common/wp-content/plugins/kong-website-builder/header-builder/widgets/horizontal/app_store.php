...
ob_start();
?>
<div class="kong-dnd__emptyItem kong-dnd__emptyItem--h" style="height:50px;" ng-if="!$ctrl.edited.attrs.image.url && $ctrl.edited.attrs.icon == 'image'">
...
add_shortcode('lhb_h_app_store', 'lhb_h_app_store_callback');
function lhb_h_app_store_callback($attrs) {
