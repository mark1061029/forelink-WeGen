...
ob_start();
?>
<div class="kong-dnd__emptyItem kong-dnd__emptyItem--h" style="width:160px;" ng-if="!$ctrl.edited.content.length">
...
add_shortcode('lhb_h_social_icons', 'lhb_h_social_icons_callback');
function lhb_h_social_icons_callback($attrs, $content = null) {
...
add_shortcode('lhb_h_social_icon', 'lhb_h_social_icon_callback');
function lhb_h_social_icon_callback($attrs) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
        'icon' => 'fa-twitter',
