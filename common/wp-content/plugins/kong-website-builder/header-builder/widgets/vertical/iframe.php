...
ob_start();
?>
<div class="kong-dnd__emptyItem kong-dnd__emptyItem--v" style="height:100px;" ng-if="!$ctrl.edited.attrs.iframe">
...
add_shortcode('lhb_v_iframe', 'lhb_v_iframe_callback');
function lhb_v_iframe_callback($attrs) {
