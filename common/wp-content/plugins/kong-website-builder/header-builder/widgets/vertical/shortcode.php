...
ob_start();
?>
<div class="kong-dnd__emptyItem kong-dnd__emptyItem--v" style="height:100px;" ng-if="!$ctrl.edited.content">
...
add_shortcode('lhb_v_shortcode', 'lhb_v_shortcode_callback');
function lhb_v_shortcode_callback($attrs, $content = null) {
