...
ob_start();
?>
<div class="kong-dnd__emptyItem kong-dnd__emptyItem--v" style="height:60px;" ng-if="!$ctrl.edited.content">
...
add_shortcode('lhb_v_button', 'lhb_v_button_callback');
function lhb_v_button_callback($attrs, $content = null) {
