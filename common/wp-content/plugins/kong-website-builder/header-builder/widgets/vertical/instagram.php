...
ob_start();
?>
    <div class="{{::$ctrl.getID()}}" kong-instagram number-items="$ctrl.edited.attrs.num"></div>
<?php
$widget['visual_view'] = ob_get_clean();
$manager->add($widget);

add_shortcode('lhb_v_instagram', 'lhb_v_instagram_callback');
function lhb_v_instagram_callback($attrs) {
    ...
    <div class="kong-aside__mediaStream kong-instagram <?php echo implode(' ', $classes); ?>"
