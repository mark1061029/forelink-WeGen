...
<div class="{{::$ctrl.getID()}}" ng-class="[{'kong-gallery--noGutter' : !$ctrl.edited.attrs.gutter},$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]"
     kong-instagram number-items="$ctrl.edited.attrs.num" resolution="$ctrl.edited.attrs.resolution"></div>
<?php
$widget['visual_view'] = ob_get_clean();
$manager->add($widget);

add_shortcode('lfb_instagram', 'lfb_instagram_callback');
function lfb_instagram_callback($attrs) {
    ...
    <div class="<?php echo implode(' ', $classes); ?>">
        <div class="kong-instagram kong-gallery"
             data-template='<div class="kong-gallery__item"><a class="kong-gallery__item__wrap" target="_blank" href="{{href}}" title="{{title}}"><img src="{{src}}" alt="{{alt}}"/></a></div>'
             data-num="<?php echo $attrs['num'] ?>" data-resolution="<?php echo $attrs['resolution'] ?>">
