...
add_shortcode('kong_grid', 'kong_grid_callback');
function kong_grid_callback($attrs, $content) {
...
add_shortcode('kong_grid_column', 'kong_grid_column_callback');
function kong_grid_column_callback($attrs, $content) {
    $attrs = shortcode_atts(array(
        'width' => '1-2',
    ), $attrs, KongPageBuilderClient::KONG_SHORTCODE_ATTS_FILTER);
