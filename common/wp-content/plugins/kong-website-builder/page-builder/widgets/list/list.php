...
add_shortcode('kong_list', 'kong_list_callback');
function kong_list_callback($attrs, $content = null) {
...
add_shortcode('kong_list_item', 'kong_list_item_callback');
function kong_list_item_callback($attrs, $content = null) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
        'text' => '',
