...
ob_start();
?>
<div class="kong-dnd__emptyItem" style="height:60px;" ng-if="!$ctrl.edited.content.length">
...
add_shortcode('kong_social_icons', 'kong_social_icons_callback');
function kong_social_icons_callback($attrs, $content = null) {
    ...
    $attrs['animation']['selector'] = '.kong-socialIcons__item';
    ...
    ob_start(); ?>
    <div class="kong-socialIcons <?php echo implode(' ', $classes); ?>"<?php echo $id.$animation; ?>>
...
add_shortcode('kong_social_icon', 'kong_social_icon_callback');
function kong_social_icon_callback($attrs) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
        'icon' => 'fa-twitter',
