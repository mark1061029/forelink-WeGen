...
add_shortcode('kong_map', 'kong_map_callback');
function kong_map_callback($attrs, $content = null) {
...
add_shortcode('kong_marker', 'kong_marker_callback');
function kong_marker_callback($attrs) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
        'center' => 'true',
        'lat' => '59.327',
